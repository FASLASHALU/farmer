...
class packed_wid extends StatefulWidget {
  const packed_wid({super.key});

  @override
  State<packed_wid> createState() => _packed_widState();
}

class _packed_widState extends State<packed_wid> {
  @override
  ...
  List<dynamic> image = [
    "asset/Stem_with_kandari1.jpg",
    "asset/COCONT1.jpg",
    "asset/Chilly2.jpg",
    "asset/Coriander1.jpg",
  ];
  List<String> item = [
    'Banana stem with Kandhari',
    'Coconut Oil',
    'Chilly Powder',
    'Coriander Powder',
  ];
