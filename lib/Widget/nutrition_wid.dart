...
class nutrition_wid extends StatefulWidget {
  const nutrition_wid({super.key});

  @override
  State<nutrition_wid> createState() => _nutrition_widState();
}

class _nutrition_widState extends State<nutrition_wid> {
  @override
  ...
  List<dynamic> image = [
    "asset/Mixedsprout1.jpg",
    "asset/mix_(1).jpg",
    "asset/healthmix1.jpg",
    "asset/radishwhite1.jpg",
  ];
  List<String> item = [
    'Mixed Sprouts',
    'Mix Microgreen',
