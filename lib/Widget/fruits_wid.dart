...
class fruits_wid extends StatefulWidget {
  const fruits_wid({super.key});

  @override
  State<fruits_wid> createState() => _fruits_widState();
}

class _fruits_widState extends State<fruits_wid> {
  @override
