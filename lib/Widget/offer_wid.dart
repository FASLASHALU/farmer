...
class offer_wid extends StatefulWidget {
  const offer_wid({super.key});

  @override
  State<offer_wid> createState() => _offer_widState();
}

class _offer_widState extends State<offer_wid> {
  @override
